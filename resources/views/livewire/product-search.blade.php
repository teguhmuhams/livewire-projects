<div class="container mx-auto py-16 px-8">
    ...
    <table class="table-auto w-full">
        <thead>
            <tr>
                <th class="py-3 px-3 bg-gray-100 border-b-2 text-left">ID</th>
                <th class="py-3 px-3 bg-gray-100 border-b-2 text-left">Image</th>
                <th class="py-3 px-3 bg-gray-100 border-b-2 text-left">Title</th>
                <th class="py-3 px-3 bg-gray-100 border-b-2 text-left">Price</th>
            </tr>
        </thead>
        <tbody>
